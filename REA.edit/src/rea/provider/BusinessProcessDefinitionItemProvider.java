...
/**
 * This is the item provider adapter for a {@link rea.BusinessProcessDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessProcessDefinitionItemProvider extends REAConceptItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessProcessDefinition_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessProcessDefinition_name_feature", "_UI_BusinessProcessDefinition_type"),
				 reaPackage.Literals.BUSINESS_PROCESS_DEFINITION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(reaPackage.Literals.BUSINESS_PROCESS_DEFINITION__REA_PROCESSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(reaPackage.Literals.BUSINESS_PROCESS_DEFINITION__REA_PROCESSES,
				 reaFactory.eINSTANCE.createExchange()));

		newChildDescriptors.add
			(createChildParameter
				(reaPackage.Literals.BUSINESS_PROCESS_DEFINITION__REA_PROCESSES,
				 reaFactory.eINSTANCE.createConversion()));
	}
